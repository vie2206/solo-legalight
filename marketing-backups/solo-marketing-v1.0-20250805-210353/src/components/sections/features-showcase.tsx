...
const mockupComponents = {
  'rank-predictor': () => (
    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md">
      ...
      <div className="h-full p-6">
        ...
        <div className="mb-6 grid grid-cols-2 gap-4">
          <div className="rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 p-4 text-center text-white">
            <div className="text-2xl font-bold">Rank 245</div>
            <div className="text-sm opacity-90">Predicted Rank</div>
            <div className="mt-1 text-xs">85% Confidence</div>
          </div>
          <div className="rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 p-4 text-center text-white">
            ...
            <div className="mt-1 text-xs">High Chance</div>
          </div>
        </div>

        <div className="space-y-3">
          <div className="flex items-center justify-between rounded-lg bg-white/10 p-3">
            <span className="font-medium text-white">NLSIU Bangalore</span>
            <span className="font-bold text-green-400">78% Chance</span>
          </div>
          <div className="flex items-center justify-between rounded-lg bg-white/10 p-3">
            <span className="font-medium text-white">NALSAR Hyderabad</span>
            <span className="font-bold text-blue-400">92% Chance</span>
          </div>
          <div className="flex items-center justify-between rounded-lg bg-white/10 p-3">
            <span className="font-medium text-white">WBNUJS Kolkata</span>
            <span className="font-bold text-green-400">95% Chance</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md">
      <div className="h-full p-6">
        <div className="mb-4 flex items-center gap-3">
          ...
          <h3 className="text-lg font-bold text-white">
            3-Stage Mock Analysis
          </h3>
        </div>

        <div className="mb-4 grid grid-cols-3 gap-3">
          <div className="rounded-lg border border-purple-500/30 bg-purple-500/20 p-3 text-center">
            <div className="text-lg font-bold text-purple-300">DECODE</div>
            <div className="text-xs text-gray-300">Performance Analysis</div>
          </div>
          <div className="rounded-lg border border-blue-500/30 bg-blue-500/20 p-3 text-center">
            <div className="text-lg font-bold text-blue-300">TRACK</div>
            <div className="text-xs text-gray-300">Progress Monitoring</div>
          </div>
          <div className="rounded-lg border border-green-500/30 bg-green-500/20 p-3 text-center">
        ...
        <div className="space-y-3">
          <div className="rounded-lg border border-blue-500/20 bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-4">
            ...
            <p className="text-sm text-gray-300">
              Your Legal Reasoning improved 12% but focus on Constitutional Law.
              Allocate 40% more time to this section.
            </p>
          </div>
  ...
  'weekly-insights': () => (
    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md">
      <div className="h-full p-6">
        ...
        <div className="mb-4 rounded-xl border border-green-500/30 bg-gradient-to-r from-green-500/20 to-emerald-500/20 p-4">
          <div className="mb-2 flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-lg border border-orange-500/30 bg-orange-500/20 p-3">
            <div className="mb-1 text-sm font-medium text-orange-200">
              Efficiency
            </div>
        ...
        <div className="mt-4 rounded-lg border border-yellow-500/30 bg-yellow-500/20 p-3">
          ...
          <div className="mt-1 text-xs text-yellow-100">
            Master Constitutional Law fundamentals
          </div>
        </div>
      </div>
    </div>
  ...
  community: () => (
    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md">
      <div className="h-full p-6">
        ...
        <div className="mb-4 rounded-xl border border-orange-500/30 bg-gradient-to-r from-orange-500/20 to-red-500/20 p-4">
          <div className="mb-3 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-orange-500 to-red-500 font-bold text-white">
              A
            </div>
            <div>
          ...
          <p className="text-sm text-orange-100">
            "Focus on landmark constitutional cases from 2020-2024. They're
            frequently tested!"
          </p>
        </div>
  ...
  'reading-mastery': () => (
    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md">
      <div className="h-full p-6">
        ...
        <div className="mb-4 rounded-xl border border-indigo-500/30 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 p-4">
          ...
          <h4 className="mb-2 text-sm font-semibold text-white">
            "Constitutional Morality in Modern India"
          </h4>
    ...
    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md">
      <div className="h-full p-6">
        ...
        <div className="mb-4 text-center">
          <div className="mb-2 bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-6xl font-bold text-transparent">
            23
          </div>
        ...
        <div className="space-y-3">
          <div className="rounded-lg border border-yellow-500/30 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 p-3">
            ...
            <div className="text-xs text-yellow-100">
              "3-Week Warrior" - Study for 21 consecutive days
            </div>
          </div>
      ...
      <div className="h-full p-6">
        ...
        <div className="mb-6 text-center">
          <div className="mb-4 grid grid-cols-4 gap-2">
            <div className="rounded-lg bg-gradient-to-r from-pink-500 to-rose-500 p-3 text-center text-white">
            ...
            <div className="rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 p-3 text-center text-white">
              <div className="text-2xl font-bold">23</div>
              <div className="text-xs">Minutes</div>
            </div>
            <div className="rounded-lg bg-gradient-to-r from-green-500 to-blue-500 p-3 text-center text-white">
        ...
        <div className="space-y-3">
          <div className="rounded-lg border border-rose-500/30 bg-gradient-to-r from-rose-500/20 to-pink-500/20 p-3">
            <div className="mb-1 flex items-center gap-2">
            ...
            <div className="text-sm text-white">
              Complete Legal Reasoning Module
            </div>
  ...
  'ai-planner': () => (
    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md">
      <div className="h-full p-6">
        ...
        <div className="mb-4 rounded-xl border border-teal-500/30 bg-gradient-to-r from-teal-500/20 to-green-500/20 p-3">
          <div className="mb-2 flex items-center gap-2">
          ...
          <p className="text-sm text-white">
            Based on your performance, focus on Constitutional Law today.
            Optimal study time: 9:00 AM - 11:30 AM
          </p>
        </div>

        <div className="mb-4 space-y-2">
          <div className="flex items-center justify-between rounded-lg border border-purple-500/30 bg-purple-500/20 p-3">
            <div>
            ...
            <div className="font-bold text-purple-400">9:00 AM</div>
          </div>

          <div className="flex items-center justify-between rounded-lg border border-blue-500/30 bg-blue-500/20 p-3">
            <div>
            ...
            <div className="font-bold text-blue-400">12:00 PM</div>
          </div>
          ...
          <div className="flex items-center justify-between rounded-lg border border-green-500/30 bg-green-500/20 p-3">
            ...
            <div className="font-bold text-green-400">4:00 PM</div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-yellow-500/30 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 p-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-yellow-200">
              Optimized for your peak performance hours
            </span>
          </div>
        </div>
      </div>
...
export default function FeaturesShowcase() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-24">
      ...
      <div className="absolute right-10 bottom-20 h-28 w-28 animate-pulse rounded-full bg-green-500/20 blur-2xl delay-3000"></div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mb-20 text-center">
          ...
          <p className="mx-auto max-w-4xl text-xl text-gray-300 sm:text-2xl">
            Discover the groundbreaking features that make SOLO the most
            advanced CLAT preparation platform in India. Each feature represents
            years of research and development, designed to give you an
            unbeatable edge.
          </p>
        </div>
        ...
        <div className="mb-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          {industryFirstFeatures.map((feature) => (
            ...
            >
              <div
                className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r ${feature.gradient}`}
              >
        ...
        <div className="mb-20 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="space-y-8">
            <div>
              <div
                className={`mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-r ${selectedFeature.gradient}`}
              >
            ...
            <div className="space-y-3">
              {selectedFeature.highlights.map((highlight, index) => (
                <div key={index} className="flex items-start gap-3">
                  <CheckCircle
                    className={`mt-0.5 h-5 w-5 flex-shrink-0 bg-gradient-to-r ${selectedFeature.gradient} rounded-full text-white`}
                  />
          ...
          <div className="lg:pl-8">
            {mockupComponents[
              selectedFeature.mockup as keyof typeof mockupComponents
            ]()}
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="mx-auto mb-8 max-w-3xl rounded-3xl border border-white/20 bg-white/10 p-8 shadow-xl backdrop-blur-md">
            <h3 className="mb-4 text-3xl font-bold text-white">
              Experience All Features with a Free Trial
            </h3>
            <p className="mb-6 text-lg text-gray-300">
              Join 10,000+ students who are already using these revolutionary
              features to transform their CLAT preparation.
            </p>
            <Button
              asChild
              size="lg"
