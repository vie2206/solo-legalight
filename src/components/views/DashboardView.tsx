        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-blue-100">Ready to level up your CLAT preparation today?</p>
            </div>
            {onShowWeeklyInsights && (
              <button
                onClick={onShowWeeklyInsights}
                className="px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-xl font-semibold transition-all duration-200 flex items-center space-x-2"
              >
