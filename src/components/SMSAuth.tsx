  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (data.testOtp && process.env.NODE_ENV === 'development') {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">SMS Login</h2>
          ...
          {onBack && (
            <button
              onClick={onBack}
              className="w-full mt-4 text-gray-600 hover:text-gray-800 flex items-center justify-center"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            ...
            <button
              onClick={handleSendOTP}
              disabled={loading}
              className="text-blue-600 hover:text-blue-800 text-sm disabled:text-blue-400"
            >
              Resend OTP
            </button>
          </div>
