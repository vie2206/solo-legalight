...
import {
  ...
  ArrowUpRight, ArrowDownRight, Info, HelpCircle, Bell, Loader
} from 'lucide-react';
...
const AnalysisLoading = () => (
  <div className="min-h-screen bg-gray-50 flex items-center justify-center">
    <div className="text-center">
      ...
      <p className="text-gray-600">Preparing your mock test analysis...</p>
    </div>
  </div>
);
...
const CLATMockTestAnalysis: React.FC<CLATMockTestAnalysisProps> = ({ user, onBack }) => {
  ...
  const navigateToView = async (viewName: string) => {
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() => navigateToView('pretest')}
                ...
                <button
                  onClick={() => navigateToView('performance-analysis')}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <button 
                onClick={() => navigateToView('question-analysis')}
              ...
              <button 
                onClick={() => navigateToView('sequence-analysis')}
              ...
              <button 
                onClick={() => navigateToView('time-omr-analysis')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <button 
                onClick={() => navigateToView('sectional-mastery')}
              ...
              <button 
                onClick={() => navigateToView('strategic-decision-log')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <button 
                onClick={() => navigateToView('performance-benchmarking')}
              ...
              <button 
                onClick={() => navigateToView('comprehensive-review')}
              ...
              <button 
                onClick={() => navigateToView('mistake-bank')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <button 
                onClick={() => navigateToView('pattern-recognition')}
              ...
              <button 
                onClick={() => navigateToView('weakness-transformation')}
              ...
              <button
                onClick={() => navigateToView('action-plan')}
                className="bg-violet-50 hover:bg-violet-100 border border-violet-200 rounded-lg p-4 text-left transition-colors"
              >
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                onClick={() => navigateToView('next-mock-planning')}
                className="bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded-lg p-4 text-left transition-colors"
              >
              ...
              <button
                onClick={() => navigateToView('accountability-system')}
                className="bg-teal-50 hover:bg-teal-100 border border-teal-200 rounded-lg p-4 text-left transition-colors"
              >
              ...
              <button
                onClick={() => navigateToView('commitment-statement')}
              ...
              <button
                onClick={() => navigateToView('emergency-backup')}
                className="bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg p-4 text-left transition-colors"
              >
              ...
              <button
                onClick={() => navigateToView('motivation-mindset')}
              ...
              <button
                onClick={() => navigateToView('final-reflection')}
  ...
  // High-level Strategy Tracking (Simplified from Page 25)
  const StrategicDecisionLogView = () => {
    // Simplified strategy tracking data
    const strategyData = {
      overallStrategy: 'Conservative approach with selective risks',
      keyDecisions: [
        { decision: 'Skip difficult quantitative questions', outcome: 'Good - saved time', impact: 'Positive' },
        { decision: 'Spend extra time on Legal Reasoning', outcome: 'Mixed - got accuracy but lost time', impact: 'Neutral' },
        { decision: 'Attempt all English questions first', outcome: 'Excellent - built confidence', impact: 'Very Positive' }
      ],
      sectionStrategy: {
        english: 'Attempt all questions - strong area',
        legal: 'Careful reading - medium risk',
        logical: 'Skip complex puzzles - time management',
        gk: 'Quick scanning - high risk tolerance',
        quant: 'Basic questions only - low risk'
      },
      overallAssessment: {
        strategicMaturity: 7,
        riskManagement: 6,
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Strategy Tracking</h1>
            <p className="text-gray-600">High-level strategic decisions and outcomes</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-blue-800 font-medium">{strategyData.overallStrategy}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="space-y-4">
              {strategyData.keyDecisions.map((decision, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-medium text-gray-800">{decision.decision}</h3>
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getImpactColor(decision.impact)}`}>
                      {decision.impact}
                    </span>
                  </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Object.entries(strategyData.sectionStrategy).map(([section, strategy], index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-medium text-gray-800 capitalize mb-2">{section}</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {Object.entries(strategyData.overallAssessment).map(([metric, score], index) => (
                <div key={index} className="text-center">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-2xl font-bold text-gray-800 mb-1">{score}/10</div>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              <h3 className="font-medium text-blue-800 mb-2">Next Test Recommendations</h3>
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• Continue conservative approach in quantitative section</li>
                <li>• Improve time allocation in Legal Reasoning</li>
                <li>• Maintain strong performance in English Language</li>
              </ul>
            </div>
          </div>
        </div>
  ...
  // Automated Progress Tracking (Simplified from Pages 31-32)
  const WeaknessTransformationJournalView = () => {
    // Automated progress tracking data
    const progressData = {
      topWeaknesses: [
        { area: 'Quantitative Aptitude', initialScore: 45, currentScore: 62, improvement: 17, status: 'improving' },
        { area: 'Logical Puzzles', initialScore: 55, currentScore: 68, improvement: 13, status: 'improving' },
        { area: 'Current Affairs', initialScore: 60, currentScore: 70, improvement: 10, status: 'steady' }
      ],
      recentMilestones: [
        { milestone: 'Crossed 60% in Quantitative', date: '2024-01-15', impact: 'High' },
        { milestone: 'Consistent 70%+ in Legal Reasoning', date: '2024-01-10', impact: 'Medium' },
        { milestone: 'Improved RC speed by 30%', date: '2024-01-05', impact: 'High' }
      ],
      autoInsights: [
        'Quantitative improvement accelerated after focused practice',
        'Reading Comprehension shows steady progress with daily practice',
        'Legal Reasoning strength can be leveraged for higher scores'
      ],
      nextFocus: [
        'Continue quantitative practice with emphasis on speed',
        'Add current affairs daily reading routine',
        'Maintain legal reasoning excellence'
      ]
    };
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Automated weakness tracking and improvement insights</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 flex items-center">
              ...
              Weakness Areas Progress
            </h2>
            <div className="space-y-6">
              {progressData.topWeaknesses.map((weakness, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="font-medium text-gray-800">{weakness.area}</h3>
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(weakness.status)}`}>
                      {weakness.status.charAt(0).toUpperCase() + weakness.status.slice(1)}
                    </span>
                  </div>
                  <div className="grid grid-cols-3 gap-4 mb-3">
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-800">{weakness.initialScore}%</div>
                      <div className="text-xs text-gray-500">Initial</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-blue-600">{weakness.currentScore}%</div>
                      <div className="text-xs text-gray-500">Current</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-green-600">+{weakness.improvement}%</div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      ...
                      style={{width: `${weakness.currentScore}%`}}
                    ></div>
                  </div>
                </div>
              ))}
              ...
              {progressData.recentMilestones.map((milestone, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium text-gray-800">{milestone.milestone}</div>
                      <div className="text-sm text-gray-600">{milestone.date}</div>
                    </div>
                  </div>
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    milestone.impact === 'High' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'
                  }`}>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="space-y-3">
              {progressData.autoInsights.map((insight, index) => (
                <div key={index} className="flex items-start">
                  <Lightbulb className="w-5 h-5 text-purple-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">{insight}</span>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              {progressData.nextFocus.map((focus, index) => (
                <div key={index} className="flex items-start">
                  <ArrowUpRight className="w-5 h-5 text-blue-500 mr-3 mt-0.5 flex-shrink-0" />
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              <h3 className="font-medium text-blue-800 mb-2">Auto-Generated This Week</h3>
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• 3 Quantitative practice sessions scheduled</li>
                <li>• Daily current affairs reading reminder set</li>
                <li>• Weekly progress review on Friday</li>
              </ul>
            </div>
          </div>
        </div>
  ...
  // Basic Goal Setting & Reminders (Simplified from Page 37)
  const AccountabilitySystemView = () => {
    // Simple goal setting and reminders data
    const goalData = {
      currentGoals: [
        { goal: 'Score 70+ in next mock test', deadline: '2024-02-01', status: 'in-progress' },
        { goal: 'Complete 100 quantitative questions', deadline: '2024-01-25', status: 'in-progress' },
        { goal: 'Read current affairs daily', deadline: 'Ongoing', status: 'active' }
      ],
      reminders: [
        { type: 'Daily', reminder: 'Current affairs reading - 30 minutes' },
        { type: 'Weekly', reminder: 'Full mock test on Saturday' },
        { type: 'Monthly', reminder: 'Progress review and goal adjustment' }
      ],
      progressCheckins: [
        { date: '2024-01-15', status: 'On track', notes: 'Good progress in quantitative' },
        { date: '2024-01-08', status: 'Behind', notes: 'Need to focus more on current affairs' },
        { date: '2024-01-01', status: 'On track', notes: 'Strong start to the month' }
      ],
      supportSystem: {
        studyPartner: 'Available',
        mentorCheck: 'Weekly',
        parentUpdate: 'Bi-weekly'
      }
    };
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Goals & Reminders</h1>
            <p className="text-gray-600">Simple goal tracking and reminder system</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="space-y-4">
              {goalData.currentGoals.map((goal, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-medium text-gray-800">{goal.goal}</h3>
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(goal.status)}`}>
                      {goal.status.replace('-', ' ').charAt(0).toUpperCase() + goal.status.replace('-', ' ').slice(1)}
                    </span>
                  </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="space-y-4">
              {goalData.reminders.map((reminder, index) => (
                <div key={index} className="flex items-center p-4 bg-yellow-50 rounded-lg">
                  ...
                  <div>
                    <div className="font-medium text-gray-800">{reminder.type}</div>
                    <div className="text-sm text-gray-600">{reminder.reminder}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="space-y-4">
              {goalData.progressCheckins.map((checkin, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-2">
                    <div className="font-medium text-gray-800">{checkin.date}</div>
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      checkin.status === 'On track' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'
                    }`}>
                      {checkin.status}
                    </span>
                  </div>
                  <div className="text-sm text-gray-600">{checkin.notes}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                <div className="font-medium text-purple-800">Study Partner</div>
                <div className="text-sm text-purple-600">{goalData.supportSystem.studyPartner}</div>
              </div>
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <div className="font-medium text-blue-800">Mentor Check</div>
                <div className="text-sm text-blue-600">{goalData.supportSystem.mentorCheck}</div>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="font-medium text-green-800">Parent Update</div>
                <div className="text-sm text-green-600">{goalData.supportSystem.parentUpdate}</div>
              </div>
            </div>
  ...
  // Main render logic with loading states
  if (isViewLoading) {
